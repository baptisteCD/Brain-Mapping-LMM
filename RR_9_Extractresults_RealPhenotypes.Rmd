...
imgs2 <- list.files(path = "../" , pattern = "BWAS_BWAS_Age_MRI.linear_lh_thick_FlatGIF_left_view_",  full.names = TRUE )
...
img_animated <- image_animate(img_joined, fps = 20)
# Save to disk
image_write(image = img_animated, path = "../BWAS_BWAS_Age_MRI.linear_lh_thickness_GIF_light.gif")
