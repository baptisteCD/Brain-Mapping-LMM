...
> Some brain association maps (for age at MRI) are given with the package.  They are stored in the package source folder and you can find the paths using the commands below.  
...
system.file("extdata/03_BWAS_uncorrected_realPheno", "BWAS_Age_MRI.linear", package = "brainMapR",mustWork = TRUE)
...
```{R, message=FALSE, hide=T,fig.show="hold",out.width="25%"}
...
```{R, message=FALSE, hide=T,fig.show="hold",out.width="100%"}
