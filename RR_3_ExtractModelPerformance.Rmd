...
cd /scratch/project/genetic_data_analysis/uqbcouvy/56_BWAS |;
for NNN in 0 |;
do |;
...
cd $wd/${scenario}_clusterFWER
${wd}/qsubshcom " module load R/3.5.0 |; 
cd /scratch/project_mnt/S0007/uqbcouvy/56_BWAS/ |;
for NNN in 10 100 1000 |;
do |;
...
wd="/scratch/project/genetic_data_analysis/uqbcouvy/56_BWAS/"
